...
class Dev(Configuration):
    ...
    SECRET_KEY = 'django-insecure-uy%dj@s!v0sdg#g_$-m30yq==u5lpmj&9df9ew^gg_q1*!a0z#'
    ...
    LOGGING = {
      ...
      "loggers": {
          # Only unhandled exceptions get sent to admin.
          "django.request": {
              "handlers": ["mail_admins"],
              "level": "ERROR",
              # Logs the stack traces to the console during development.
              "propagate": True,
          },
      },
      "root": {
